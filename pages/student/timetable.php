            ...
            <nav class="col-md-2 d-none d-md-block bg-dark sidebar min-vh-100" style="padding:0; position: fixed;">
                <div class="position-sticky">
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item" >
                            <a class="nav-link text-white" href="/qlTruongMauGiao/pages/student/attendance.php">
                        ...
                        <li class="nav-item" style="background:#575f66">
                            <a class="nav-link text-white" href="/qlTruongMauGiao/pages/student/timetable.php">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-white" href="/qlTruongMauGiao/pages/student/event.php">
