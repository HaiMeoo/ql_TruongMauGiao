...
<body>
   ...
   <section class="blog">
        <div class="banner">
            <img class="img-event" src="../images/banner-tintuc.jpg" alt="">
        </div>
    ...
    <script>
        ...
        const events = [
            ...
            },
            {
                ...
                image: "../images/event-khamsuckhoe1.jpg",
            ...
            },
            {
                ...
                image: "../images/event-phattriencamxuc.jpg",
            ...
            },
            {
                ...
                image: "../images/event-mamxanh.jpg",
                url:"nuoi-duong-mam-xanh-yeu-thuong.php"
            },
            {
                ...
                image: "../images/event-docsach.jpg",
                url:""
            },
           
            {
                ...
                image: "../images/event-sangtao.jpg",
