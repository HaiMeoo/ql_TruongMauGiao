...
(3, 'CHƯƠNG TRÌNH NGOẠI KHÓA', 'Trường Mẫu Giáo Hoa Hồng tổ chức chương trình ngoại khóa đa dạng và phong phú, nhằm giúp trẻ phát triển toàn diện về mặt tư duy, thể chất và kỹ năng xã hội. Chương trình bao gồm nhiều hoạt động đa dạng như thể thao, hội họa, âm nhạc, múa, kể chuyện, nấu ăn và các hoạt động đồng hành khác. Những hoạt động này giúp trẻ rèn luyện và phát triển kỹ năng sáng tạo, tư duy logic, kỹ năng xã hội và rèn luyện sức khỏe, tạo cơ hội cho trẻ học hỏi, khám phá thế giới xung quanh và phát triển khả năng tự lập. Chương trình ngoại khóa của Mẫu Giáo Hoa Hồng cũng giúp trẻ tạo ra những kết nối xã hội, giao lưu và kết bạn mới, giúp trẻ học hỏi và trải nghiệm những giá trị văn hóa, đồng thời giúp trẻ phát triển sự tự tin và khả năng thích ứng với những môi trường mới.', 'cth3.png');
